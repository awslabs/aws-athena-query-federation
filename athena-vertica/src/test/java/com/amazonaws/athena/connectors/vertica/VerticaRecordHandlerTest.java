        ...
        extends TestBase
{
    ...
    public void testConstructor() {
        ...
        configOptions.put("test_key", "test_value");
        VerticaRecordHandler handler = new VerticaRecordHandler(configOptions);
        org.junit.Assert.assertNotNull("Handler should not be null", handler);
    }
