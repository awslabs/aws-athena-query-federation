...
public class VerticaRecordHandler
    ...
    @VisibleForTesting
    protected VerticaRecordHandler(AmazonS3 amazonS3, SecretsManagerClient secretsManager, AthenaClient amazonAthena, java.util.Map<String, String> configOptions)
    {
