...
public class LarkBaseServiceTest {
    ...
    @Test
    public void getTableFields_success_multiplePages() throws Exception {
        String baseId = "base1";
        String tableId = "tbl1";
    ...
    @Test
    public void getLookupType_success() throws Exception {
        String baseId = "base1";
        String tableId = "tbl1";
        String fieldId = "fld1";
        String mockJsonResponse = "{\"code\":0, \"data\":{\"items\":[{\"field_id\":\"fld1\",\"field_name\":\"Field 1\",\"ui_type\":\"Text\"}],\"has_more\":false}}";
    ...
    @Test
    public void getLookupType_notFound() throws Exception {
        String baseId = "base1";
        String tableId = "tbl1";
        String fieldId = "fld2";
        String mockJsonResponse = "{\"code\":0, \"data\":{\"items\":[{\"field_id\":\"fld1\",\"field_name\":\"Field 1\",\"ui_type\":\"Text\"}],\"has_more\":false}}";
    ...
    @Test
    public void getLookupType_recursive() throws Exception {
        String baseId = "base1";
        String tableId1 = "tbl1";
        String fieldId1 = "fld1";
        String tableId2 = "tbl2";
        String fieldId2 = "fld2";
    ...
    public void getDatabaseRecords_withNullFields() throws Exception {
        ...
        assertEquals(null, result.get(0).name());
    }
    ...
    public void getTableRecords_withNullItems() throws Exception {
        ...
        assertEquals(true, result.getItems() == null || result.getItems().isEmpty());
    }

    @Test
    public void fetchTableFieldsUncached_refreshTokenFailure() throws Exception {
    ...
    @Test
    public void listTables_withNoMoreDataCode() throws Exception {
        String baseId = "base123";
    ...
    @Test
    public void listTables_withNullItems() throws Exception {
        String baseId = "base123";
    ...
    @Test
    public void getTableFields_withNullItems() throws Exception {
        String baseId = "base1";
        String tableId = "tbl1";
        String mockJsonResponse = "{\"code\":0, \"data\":{\"items\":null,\"has_more\":false}}";
