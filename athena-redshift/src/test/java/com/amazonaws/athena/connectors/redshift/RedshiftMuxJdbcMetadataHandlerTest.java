...
public class RedshiftMuxJdbcMetadataHandlerTest
{
    ...
    public void doListSchemaNames()
            throws Exception
    {
        ListSchemasRequest listSchemasRequest = ListSchemasRequest.newBuilder().setCatalogName("redshift").build();
    ...
    public void doListTables()
            throws Exception
    {
        ListTablesRequest listTablesRequest = ListTablesRequest.newBuilder().setCatalogName("redshift").build();
    ...
    public void doGetTable()
            throws Exception
    {
        GetTableRequest getTableRequest = GetTableRequest.newBuilder().setCatalogName("redshift").build();
    ...
    public void doGetTableLayout()
            throws Exception
    {
        GetTableLayoutRequest getTableLayoutRequest = GetTableLayoutRequest.newBuilder().setCatalogName("redshift").setTableName(TableName.newBuilder().setSchemaName("testSchema").setTableName("testTable").build()).build();
    ...
    {
        this.jdbcMetadataHandler.getPartitionSchema("redshift");
        Mockito.verify(this.redshiftMetadataHandler, Mockito.times(1)).getPartitionSchema(Mockito.eq("redshift"));
    }
    ...
    public void getPartitions()
            throws Exception
    {
        GetTableLayoutRequest getTableLayoutRequest = GetTableLayoutRequest.newBuilder().setCatalogName("redshift").build();
        ...
        Mockito.verify(this.redshiftMetadataHandler, Mockito.times(1)).getPartitions(nullable(BlockAllocator.class), nullable(BlockWriter.class), Mockito.eq(getTableLayoutRequest), Mockito.eq(queryStatusChecker));
    }

    @Test
    public void doGetSplits()
    {
        GetSplitsRequest getSplitsRequest = GetSplitsRequest.newBuilder().setCatalogName("redshift").build();
