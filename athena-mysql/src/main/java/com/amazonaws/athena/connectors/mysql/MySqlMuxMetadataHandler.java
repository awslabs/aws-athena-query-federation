        ...
        implements JdbcMetadataHandlerFactory
{
    ...
    {
        return new MySqlMetadataHandler(config, configOptions);
    }
}
        ...
        extends MultiplexingJdbcMetadataHandler
{
    ...
    {
        super(new MySqlMetadataHandlerFactory(), configOptions);
    }
    ...
    {
        super(secretsManager, athena, jdbcConnectionFactory, metadataHandlerMap, databaseConnectionConfig, configOptions, new MySqlJDBCCaseResolver(MYSQL_NAME));
    }
}
