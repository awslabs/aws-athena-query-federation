...
public class MySqlMuxJdbcMetadataHandlerTest
{
            ...
            throws Exception
    {
        ...
        Mockito.verify(this.mySqlMetadataHandler, Mockito.times(1)).getPartitions(nullable(BlockAllocator.class), nullable(BlockWriter.class), Mockito.eq(getTableLayoutRequest), Mockito.eq(queryStatusChecker));
    }
