...
public class PostgresqlSqlDialectTest
{
    ...
    {
        assertNotNull(PostgresqlSqlDialect.DEFAULT);
    }

    @Test
    void testQuoteIdentifierWithFilter()
    {
        PostgresqlSqlDialect dialect = new PostgresqlSqlDialect(true);
    ...
    {
        PostgresqlSqlDialect dialect = new PostgresqlSqlDialect(false);
        StringBuilder buf = new StringBuilder();
        dialect.quoteIdentifier(buf, "employees");
        assertEquals("\"employees\"", buf.toString());
    }
