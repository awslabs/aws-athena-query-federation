...
public class TeradataMuxJdbcMetadataHandlerTest {
            ...
            throws Exception
    {
        ...
        Mockito.verify(this.teradataMetadataHandler, Mockito.times(1)).doListSchemaNames(Mockito.eq(this.allocator), Mockito.eq(listSchemasRequest));
    }
            ...
            throws Exception
    {
        ...
        Mockito.verify(this.teradataMetadataHandler, Mockito.times(1)).doListTables(Mockito.eq(this.allocator), Mockito.eq(listTablesRequest));
    }
            ...
            throws Exception
    {
        ...
        Mockito.verify(this.teradataMetadataHandler, Mockito.times(1)).doGetTable(Mockito.eq(this.allocator), Mockito.eq(getTableRequest));
    }
            ...
            throws Exception
    {
        ...
        Mockito.verify(this.teradataMetadataHandler, Mockito.times(1)).doGetTableLayout(Mockito.eq(this.allocator), Mockito.eq(getTableLayoutRequest));
    }
            ...
            throws Exception
    {
        ...
        Mockito.verify(this.teradataMetadataHandler, Mockito.times(1)).getPartitions(nullable(BlockAllocator.class), nullable(BlockWriter.class), Mockito.eq(getTableLayoutRequest), Mockito.eq(queryStatusChecker));
    }
    ...
    public void doGetSplits()
    {
        ...
        Mockito.verify(this.teradataMetadataHandler, Mockito.times(1)).doGetSplits(Mockito.eq(this.allocator), Mockito.eq(getSplitsRequest));
    }
}
