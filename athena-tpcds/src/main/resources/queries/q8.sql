SELECT
  s_store_name,
  sum(ss_net_profit)
FROM store_sales[ TABLE_SUFFIX ], date_dim[ TABLE_SUFFIX ], store[ TABLE_SUFFIX ],
  (SELECT ca_zip
  FROM (
         (SELECT substr(ca_zip, 1, 5) ca_zip
         FROM customer_address[ TABLE_SUFFIX ]
         ...
         FROM
           (SELECT
             ...
             count(*) cnt
           FROM customer_address[ TABLE_SUFFIX ], customer[ TABLE_SUFFIX ]
