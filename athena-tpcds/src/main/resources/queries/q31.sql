...
(SELECT
  ...
  FROM store_sales[ TABLE_SUFFIX ], date_dim[ TABLE_SUFFIX ], customer_address[ TABLE_SUFFIX ]
  ...
  FROM web_sales[ TABLE_SUFFIX ], date_dim[ TABLE_SUFFIX ], customer_address[ TABLE_SUFFIX ]
