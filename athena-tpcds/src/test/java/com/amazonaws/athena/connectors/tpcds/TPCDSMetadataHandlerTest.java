...
public class TPCDSMetadataHandlerTest
{
    ...
    public void setUp()
            throws Exception
    {
        handler = new TPCDSMetadataHandler(new LocalKeyFactory(), mockSecretsManager, "spillBucket", "spillPrefix");
    ...
    public void doListTables()
    {
        ...
        ListTablesRequest req = new ListTablesRequest(identity, "queryId", "default", "tpcds1");
