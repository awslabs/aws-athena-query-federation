...
public class ImpalaIntegTest extends IntegrationTestBase {

    private static final Logger logger = LoggerFactory.getLogger(ImpalaIntegTest.class);
    ...
    static {
        ...
        tableName1 = testConfig.getStringItem("impala_table_name1").get();
        tableName2 = testConfig.getStringItem("impala_table_name2").get();
        tableName3 = testConfig.getStringItem("impala_table_name3").get();
        tableName4 = testConfig.getStringItem("impala_table_name4").get();
        schemaName = testConfig.getStringItem("impala_schema_name").get();
    }
    ...
    public void getThroughput() {
        ...
        logger.info("Throughput for Impala Connector: " + throughput);
    }
}
