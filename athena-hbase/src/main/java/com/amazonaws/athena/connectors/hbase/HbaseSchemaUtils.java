    ...
    private static Schema scanAndInferSchema(ResultScanner scanner) throws java.io.UnsupportedEncodingException
    {
        ...
        for (Result result : scanner) {
            ...
            for (Cell cell : result.listCells()) {
                fieldCount++;
                String family = new String(cell.getFamilyArray(), "UTF8");
                String column = new String(cell.getQualifierArray(), "UTF8");
                ...
                Types.MinorType inferredType = inferType(cell.getValueArray());
