        ...
        extends RecordHandler
{
    ...
    @VisibleForTesting
    public BigQueryRecordHandler(S3Client amazonS3, SecretsManagerClient secretsManager, AmazonAthena athena, java.util.Map<String, String> configOptions, BufferAllocator allocator)
    {
