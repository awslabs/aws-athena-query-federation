        ...
        extends RecordHandler
{
    ...
    @VisibleForTesting
    public BigQueryRecordHandler(AmazonS3 amazonS3, SecretsManagerClient secretsManager, AthenaClient athena, java.util.Map<String, String> configOptions, BufferAllocator allocator)
    {
