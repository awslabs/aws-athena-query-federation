 ...
 * #L%
 */
package com.amazonaws.athena.connectors.db2as400.integ;
...
/**
 * Integration-tests for the Db2as400 (JDBC) connector using the Integration-test module.
 */
public class Db2As400IntegTest extends IntegrationTestBase {

    private static final Logger logger = LoggerFactory.getLogger(Db2As400IntegTest.class);
    private App theApp;
    ...
    public Db2As400IntegTest() throws Exception
    {
    ...
    public void getThroughput() {
        ...
        logger.info("throughput for db2as400 connector: "+ throughput);
    }
}
