...
class Db2As400MuxRecordHandlerFactory implements JdbcRecordHandlerFactory
{
    @Override
    public String getEngine()
    {
        return Db2As400Constants.NAME;
    }
    ...
    {
        return new Db2As400RecordHandler(config, configOptions);
    }
}

public class Db2As400MuxRecordHandler extends MultiplexingJdbcRecordHandler
{
    public Db2As400MuxRecordHandler(java.util.Map<String, String> configOptions)
    {
        super(new Db2As400MuxRecordHandlerFactory(), configOptions);
    }

    @VisibleForTesting
    Db2As400MuxRecordHandler(S3Client amazonS3, SecretsManagerClient secretsManager, AmazonAthena athena, JdbcConnectionFactory jdbcConnectionFactory,
