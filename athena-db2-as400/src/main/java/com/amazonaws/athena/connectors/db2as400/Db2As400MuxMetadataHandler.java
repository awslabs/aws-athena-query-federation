...
class Db2As400MetadataHandlerFactory
        implements JdbcMetadataHandlerFactory
{
    ...
    {
        return new Db2As400MetadataHandler(config, configOptions);
    }
}

public class Db2As400MuxMetadataHandler
        extends MultiplexingJdbcMetadataHandler
{
    public Db2As400MuxMetadataHandler(java.util.Map<String, String> configOptions)
    {
        super(new Db2As400MetadataHandlerFactory(), configOptions);
    }
