...
public class OracleMuxJdbcMetadataHandlerTest
{
            ...
            throws Exception
    {
        ...
        Mockito.verify(this.oracleMetadataHandler, Mockito.times(1)).doListTables(Mockito.eq(this.allocator), Mockito.eq(listTablesRequest));
    }
            ...
            throws Exception
    {
        ...
        Mockito.verify(this.oracleMetadataHandler, Mockito.times(1)).doGetTableLayout(Mockito.eq(this.allocator), Mockito.eq(getTableLayoutRequest));
    }
