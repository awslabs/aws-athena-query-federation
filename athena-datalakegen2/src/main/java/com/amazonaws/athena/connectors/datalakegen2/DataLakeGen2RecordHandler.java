...
public class DataLakeGen2RecordHandler extends JdbcRecordHandler
{
    ...
    {
        this(databaseConnectionConfig, S3Client.create(), SecretsManagerClient.create(), AmazonAthenaClientBuilder.defaultClient(),
    ...
    @VisibleForTesting
    DataLakeGen2RecordHandler(DatabaseConnectionConfig databaseConnectionConfig, S3Client amazonS3, SecretsManagerClient secretsManager, AmazonAthena athena, JdbcConnectionFactory jdbcConnectionFactory, JdbcSplitQueryBuilder jdbcSplitQueryBuilder, java.util.Map<String, String> configOptions)
    {
