...
public class DataLakeGen2JdbcConnectionFactory extends GenericJdbcConnectionFactory
{
     ...
     */
    public DataLakeGen2JdbcConnectionFactory(DatabaseConnectionConfig databaseConnectionConfig, Map<String, String> properties, DatabaseConnectionInfo databaseConnectionInfo)
    {
