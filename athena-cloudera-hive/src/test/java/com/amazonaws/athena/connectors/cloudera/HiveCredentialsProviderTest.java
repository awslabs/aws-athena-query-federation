...
public class HiveCredentialsProviderTest
{
    ...
    private HiveCredentialsProvider credentialsProvider;

    @Test
    public void getCredentialMap_withValidSecret_returnsValidCredentials()
    {
        credentialsProvider = new HiveCredentialsProvider(VALID_SECRET_STRING);
        ...
        assertEquals("Username should match", TEST_USERNAME, credentialMap.get(HiveConstants.USER));
        assertEquals("Password should match", TEST_PASSWORD, credentialMap.get(HiveConstants.PASSWORD));
    }

    @Test
    public void createHiveCredentialsProvider_withInvalidSecret_throwsAthenaConnectorException()
    {
        try {
            credentialsProvider = new HiveCredentialsProvider(INVALID_SECRET_STRING);
