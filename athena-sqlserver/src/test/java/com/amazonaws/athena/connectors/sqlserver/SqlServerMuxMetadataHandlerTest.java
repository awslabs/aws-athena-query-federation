...
public class SqlServerMuxMetadataHandlerTest
{
    ...
    public void setup()
    {
        ...
        this.sqlServerMetadataHandler = Mockito.mock(SqlServerMetadataHandler.class);
        this.metadataHandlerMap = Collections.singletonMap("fakedatabase", this.sqlServerMetadataHandler);
            ...
            throws Exception
    {
        ...
        Mockito.verify(this.sqlServerMetadataHandler, Mockito.times(1)).doListTables(Mockito.eq(this.allocator), Mockito.eq(listTablesRequest));
    }
    ...
    public void getPartitionSchema()
    {
        ...
        Mockito.verify(this.sqlServerMetadataHandler, Mockito.times(1)).getPartitionSchema(Mockito.eq("fakedatabase"));
    }
            ...
            throws Exception
    {
        ...
        Mockito.verify(this.sqlServerMetadataHandler, Mockito.times(1)).getPartitions(nullable(BlockAllocator.class), nullable(BlockWriter.class), Mockito.eq(getTableLayoutRequest), Mockito.eq(queryStatusChecker));
    }
