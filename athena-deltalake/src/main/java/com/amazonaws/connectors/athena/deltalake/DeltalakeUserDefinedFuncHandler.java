...
public class DeltalakeUserDefinedFuncHandler
        extends UserDefinedFunctionHandler
{
    private static final Logger logger = LoggerFactory.getLogger(DeltalakeUserDefinedFuncHandler.class);

    private static final String SOURCE_TYPE = "custom";

    public DeltalakeUserDefinedFuncHandler()
    {
        super(SOURCE_TYPE);
    }
