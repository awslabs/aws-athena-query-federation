...
public class DeltalakeUserDefinedFuncHandlerTest
{
    private static final Logger logger = LoggerFactory.getLogger(DeltalakeUserDefinedFuncHandlerTest.class);

    private DeltalakeUserDefinedFuncHandler handler = new DeltalakeUserDefinedFuncHandler();
