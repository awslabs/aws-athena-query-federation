...
public class MetricUtilsTest
{
    ...
    public void applyMetricConstraints()
    {
        ...
        ConstraintEvaluator constraintEvaluator = new ConstraintEvaluator(allocator, schema, new Constraints(constraintsMap, Collections.emptyList(), -1));
    ...
    public void pushDownPredicate()
    {
        ...
        MetricUtils.pushDownPredicate(new Constraints(constraintsMap, Collections.emptyList(), -1), request);
