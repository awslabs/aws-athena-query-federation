        ...
        extends TestBase
{
    ...
    public void setup()
    {
        ...
        handler = new DynamoDBRecordHandler(ddbClient, mock(S3Client.class), mock(SecretsManagerClient.class), mock(AmazonAthena.class), "source_type", com.google.common.collect.ImmutableMap.of());
