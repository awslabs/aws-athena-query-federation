...
public class AwsRestHighLevelClientFactory
{
    ...
    {
        String localArn = System.getenv("LOCAL_ARN");
        String remoteArn = System.getenv("REMOTE_ARN");

        if (localArn != null && remoteArn != null) {
            return new AwsRestHighLevelClient.Builder(endpoint)
                    .withAssumedRoleCredentials(localArn, remoteArn, "athena")
                    .build();
        }
