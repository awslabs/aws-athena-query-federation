...
public class ElasticsearchUserDefinedFuncHandler
        extends UserDefinedFunctionHandler
{
    private static final Logger logger = LoggerFactory.getLogger(ElasticsearchUserDefinedFuncHandler.class);

    private static final String SOURCE_TYPE = "custom";

    public ElasticsearchUserDefinedFuncHandler()
    {
        super(SOURCE_TYPE);
    }
