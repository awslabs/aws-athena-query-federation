...
public class ElasticsearchUserDefinedFuncHandlerTest
{
    private static final Logger logger = LoggerFactory.getLogger(ElasticsearchUserDefinedFuncHandlerTest.class);

    private ElasticsearchUserDefinedFuncHandler handler = new ElasticsearchUserDefinedFuncHandler();
