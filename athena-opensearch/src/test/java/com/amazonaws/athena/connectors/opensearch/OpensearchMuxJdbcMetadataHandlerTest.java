...
public class OpensearchMuxJdbcMetadataHandlerTest
{
    ...
    public void setup()
    {
        ...
        this.opensearchMetadataHandler = Mockito.mock(OpensearchMetadataHandler.class);
        this.metadataHandlerMap = Collections.singletonMap("fakedatabase", this.opensearchMetadataHandler);
        ...
        this.jdbcMetadataHandler = new OpensearchMuxMetadataHandler(this.secretsManager, this.athena, this.jdbcConnectionFactory, this.metadataHandlerMap, databaseConnectionConfig, com.google.common.collect.ImmutableMap.of());
    }
            ...
            throws Exception
    {
        ...
        Mockito.verify(this.opensearchMetadataHandler, Mockito.times(1)).doListSchemaNames(Mockito.eq(this.allocator), Mockito.eq(listSchemasRequest));
    }
            ...
            throws Exception
    {
        ...
        Mockito.verify(this.opensearchMetadataHandler, Mockito.times(1)).doListTables(Mockito.eq(this.allocator), Mockito.eq(listTablesRequest));
    }
            ...
            throws Exception
    {
        ...
        Mockito.verify(this.opensearchMetadataHandler, Mockito.times(1)).doGetTable(Mockito.eq(this.allocator), Mockito.eq(getTableRequest));
    }
            ...
            throws Exception
    {
        ...
        Mockito.verify(this.opensearchMetadataHandler, Mockito.times(1)).doGetTableLayout(Mockito.eq(this.allocator), Mockito.eq(getTableLayoutRequest));
    }
    ...
    public void getPartitionSchema()
    {
        ...
        Mockito.verify(this.opensearchMetadataHandler, Mockito.times(1)).getPartitionSchema(Mockito.eq("fakedatabase"));
    }
            ...
            throws Exception
    {
        ...
        Mockito.verify(this.opensearchMetadataHandler, Mockito.times(1)).getPartitions(nullable(BlockWriter.class), Mockito.eq(getTableLayoutRequest), Mockito.eq(queryStatusChecker));
    }
    ...
    public void doGetSplits()
    {
        ...
        Mockito.verify(this.opensearchMetadataHandler, Mockito.times(1)).doGetSplits(Mockito.eq(this.allocator), Mockito.eq(getSplitsRequest));
    }
}
