 ...
 */
public class OpensearchRecordHandler
        extends JdbcRecordHandler
{
    ...
    public OpensearchRecordHandler(DatabaseConnectionConfig databaseConnectionConfig, JdbcConnectionFactory jdbcConnectionFactory, java.util.Map<String, String> configOptions)
    {
        this(databaseConnectionConfig, AmazonS3ClientBuilder.defaultClient(), AWSSecretsManagerClientBuilder.defaultClient(), AmazonAthenaClientBuilder.defaultClient(),
                jdbcConnectionFactory, new OpensearchQueryStringBuilder(OPENSEARCH_QUOTE_CHARACTER, new OpensearchFederationExpressionParser(OPENSEARCH_QUOTE_CHARACTER)), configOptions);
    }

    @VisibleForTesting
    OpensearchRecordHandler(DatabaseConnectionConfig databaseConnectionConfig, final AmazonS3 amazonS3, final AWSSecretsManager secretsManager,
