...
public class SynapseJDBCCaseResolverTest extends TestBase
{
    ...
    @Test
    public void getAdjustedSchemaAndTableName_withCaseInsensitiveMode_tableNameIsUpperCased() throws SQLException {
    ...
    @Test
    public void getAdjustedTableNameObject_withCaseInsensitiveMode_schemaNameIsLowerCased() throws SQLException {
        DefaultJDBCCaseResolver resolver = new SynapseJDBCCaseResolver(SynapseConstants.NAME);
