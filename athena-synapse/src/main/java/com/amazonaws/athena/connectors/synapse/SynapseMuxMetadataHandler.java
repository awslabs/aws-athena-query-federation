        ...
        extends MultiplexingJdbcMetadataHandler
{
    ...
    {
        super(secretsManager, athena, jdbcConnectionFactory, metadataHandlerMap, databaseConnectionConfig, configOptions, new SynapseJDBCCaseResolver(SynapseConstants.NAME));
    }
}
