 ...
 * #L%
 */
package com.athena.connectors.msk.integ;
...
public class AmazonMskIntegTest extends IntegrationTestBase {
    ...
    public void fetchDataTypesCsv()
    {
        ...
        logger.info("-----------------------------------");
        //int test
        String  queryTableCreation = "select * from \"lambda:" + lambdaFunctionName + "\"."+ "default" + "." + "datatypecheck where intcol=10234";
        processQuery(queryTableCreation);
        //varchar test
        queryTableCreation = "select * from \"lambda:" + lambdaFunctionName + "\"."+ "default" + "." + "datatypecheck where varcharcol='Jithendar'";
        processQuery(queryTableCreation);
        //boolean test
        queryTableCreation="select * from \"lambda:" + lambdaFunctionName + "\"."+ "default" + "." + "datatypecheck where booleancol=true";
        processQuery(queryTableCreation);
        //bigint test
        queryTableCreation="select * from \"lambda:" + lambdaFunctionName + "\"."+ "default" + "." + "datatypecheck where bigintcol= 789456";
        processQuery(queryTableCreation);
        //double test
        queryTableCreation="select * from \"lambda:" + lambdaFunctionName + "\"."+ "default" + "." + "datatypecheck where doublecol=9.229";
        processQuery(queryTableCreation);
        //smallint test
        queryTableCreation="select * from \"lambda:" + lambdaFunctionName + "\"."+ "default" + "." + "datatypecheck where smallintcol=12";
        processQuery(queryTableCreation);
        //tinyint test
        queryTableCreation="select * from \"lambda:" + lambdaFunctionName + "\"."+ "default" + "." + "datatypecheck where tinyintcol=123";
        processQuery(queryTableCreation);
    }
    @Test
    public void fetchDataTypesJson(){
        ...
        logger.info("-----------------------------------");
        //int test
        String  queryTableCreation = "select * from \"lambda:" + lambdaFunctionName + "\"."+ "default" + "." + "datatypetest3 where intcol=1";
        processQuery(queryTableCreation);
        //varchar test
        queryTableCreation = "select * from \"lambda:" + lambdaFunctionName + "\"."+ "default" + "." + "datatypetest3 where varcharcol='Jithendar'";
        processQuery(queryTableCreation);
        //boolean test
        queryTableCreation="select * from \"lambda:" + lambdaFunctionName + "\"."+ "default" + "." + "datatypetest3 where booleancol=true";
        processQuery(queryTableCreation);
        //bigint test
        queryTableCreation="select * from \"lambda:" + lambdaFunctionName + "\"."+ "default" + "." + "datatypetest3 where bigintcol=78945";
        processQuery(queryTableCreation);
        //double test
        queryTableCreation="select * from \"lambda:" + lambdaFunctionName + "\"."+ "default" + "." + "datatypetest3 where doublecol=12345.12345";
        processQuery(queryTableCreation);
        //smallint test
        queryTableCreation="select * from \"lambda:" + lambdaFunctionName + "\"."+ "default" + "." + "datatypetest3 where smallintcol=122";
        processQuery(queryTableCreation);
        //tinyint test
        queryTableCreation="select * from \"lambda:" + lambdaFunctionName + "\"."+ "default" + "." + "datatypetest3 where tinyintcol=12";
        processQuery(queryTableCreation);
        //date test
        queryTableCreation="select * from \"lambda:" + lambdaFunctionName + "\"."+ "default" + "." + "timestamptest2 where datecol=date_parse('2022-09-13','%Y-%m-%d')";
        processQuery(queryTableCreation);
    }
    @Test
