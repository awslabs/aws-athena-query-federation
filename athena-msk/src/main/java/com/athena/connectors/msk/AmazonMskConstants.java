...
public class AmazonMskConstants
{
    ...
    public static final String KAFKA_CATALOG = "kafka";
    /**
     * right now only one schema which is default has been added
     */
    public static final String KAFKA_SCHEMA = "default";
    public static final String KAFKA_QUERY_ID = "kafka_query";
    public static final String KAFKA_IDENTITY = "USER";
    /**
