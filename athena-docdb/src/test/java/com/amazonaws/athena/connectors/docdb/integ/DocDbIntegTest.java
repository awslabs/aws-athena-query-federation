...
/**
 * Integration-tests for the DocDB connector using the Integration-test framework.
 */
public class DocDbIntegTest extends IntegrationTestBase {
    ...
    /**
     * Creates a DocDB Cluster used for the integration tests.
     */
    @BeforeClass
    @Override
    protected void setUp() {
        ...
        try {
            // Create the CloudFormation stack for the DocDb cluster.
