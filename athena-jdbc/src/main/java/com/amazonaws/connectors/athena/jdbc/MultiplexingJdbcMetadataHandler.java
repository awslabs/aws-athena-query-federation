        ...
        extends JdbcMetadataHandler
{
     ...
     */
    @VisibleForTesting
    MultiplexingJdbcMetadataHandler(final AWSSecretsManager secretsManager, final JdbcConnectionFactory jdbcConnectionFactory, final Map<String, JdbcMetadataHandler> metadataHandlerMap, final DatabaseConnectionConfig databaseConnectionConfig)
    {
        super(databaseConnectionConfig, secretsManager, jdbcConnectionFactory);
