        ...
        extends TestBase
{
    ...
    private DatabaseConnectionConfig databaseConnectionConfig = new DatabaseConnectionConfig("TESTCATALOG", JdbcConnectionFactory.DatabaseEngine.SNOWFLAKE,
    ...
    {
        Assert.assertEquals(SchemaBuilder.newBuilder().build(),
            ...
            throws Exception
    {
        ...
        Assert.assertEquals(expectedValues, Arrays.asList("[partitionId : 1]"));

        SchemaBuilder expectedSchemaBuilder = SchemaBuilder.newBuilder();
        expectedSchemaBuilder.addField(FieldBuilder.newBuilder("partitionId", org.apache.arrow.vector.types.Types.MinorType.INT.getType()).build());
            ...
            throws Exception
    {
        ...
        Assert.assertEquals(expectedValues, Collections.singletonList("[partitionId : 1]"));
            ...
            throws Exception
    {
        ...
        expectedSplits.add(ImmutableMap.of());
