        ...
        extends TestBase
{
    ...
    public void setup()
    {
        ...
        this.mySqlMetadataHandler = new MySqlMetadataHandler(databaseConnectionConfig, this.secretsManager, this.jdbcConnectionFactory);
            ...
            throws Exception
    {
        ...
        MySqlMetadataHandler mySqlMetadataHandler = new MySqlMetadataHandler(databaseConnectionConfig, this.secretsManager, jdbcConnectionFactory);
