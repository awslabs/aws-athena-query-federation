...
public class    MultiplexingJdbcMetadataHandlerTest
{
    ...
    public void setup()
    {
        ...
        this.jdbcMetadataHandler = new MultiplexingJdbcMetadataHandler(this.secretsManager, this.jdbcConnectionFactory, this.metadataHandlerMap, databaseConnectionConfig);
    }
