...
public class MultiplexingJdbcRecordHandlerTest
{
    ...
    public void setup()
    {
        ...
        this.jdbcRecordHandler = new MultiplexingJdbcRecordHandler(this.amazonS3, this.secretsManager, this.jdbcConnectionFactory, databaseConnectionConfig, this.recordHandlerMap);
    }
