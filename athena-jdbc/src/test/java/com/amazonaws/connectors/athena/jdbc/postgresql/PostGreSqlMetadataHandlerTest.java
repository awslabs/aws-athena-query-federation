        ...
        extends TestBase
{
    ...
    public void setup()
    {
        ...
        this.postGreSqlMetadataHandler = new PostGreSqlMetadataHandler(databaseConnectionConfig, this.secretsManager, this.jdbcConnectionFactory);
            ...
            throws Exception
    {
        ...
        PostGreSqlMetadataHandler postGreSqlMetadataHandler = new PostGreSqlMetadataHandler(databaseConnectionConfig, this.secretsManager, jdbcConnectionFactory);
