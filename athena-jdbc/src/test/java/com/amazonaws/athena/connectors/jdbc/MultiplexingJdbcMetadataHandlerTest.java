...
public class MultiplexingJdbcMetadataHandlerTest
{
    ...
    public void doGetTableLayout()
            throws Exception
    {
        GetTableLayoutRequest getTableLayoutRequest = GetTableLayoutRequest.newBuilder().setCatalogName("fakedatabase").setTableName(TableName.newBuilder().setSchemaName("testSchema").setTableName("testTable").build()).build();
            ...
            throws Exception
    {
        ...
        Mockito.verify(this.fakeDatabaseHandler, Mockito.times(1)).getPartitions(nullable(BlockAllocator.class), nullable(BlockWriter.class), Mockito.eq(getTableLayoutRequest), Mockito.eq(queryStatusChecker));
    }
