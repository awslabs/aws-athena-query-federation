...
public abstract class AbstractTableProviderTest
{
    ...
    public void readTableTest()
    {
        ...
        constraintsMap.put(idField,
                EquatableValueSet.newBuilder(allocator, Types.MinorType.VARCHAR.getType(), true).add(idValue).build());
        ...
        BlockSpiller spiller = new S3BlockSpiller(amazonS3, spillConfig, allocator, response.getSchema());
        provider.readWithConstraint(evaluator, spiller, readRequest);
