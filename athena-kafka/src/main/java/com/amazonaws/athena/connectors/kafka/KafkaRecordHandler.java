        ...
        extends RecordHandler
{
    ...
    public void readWithConstraint(BlockAllocator allocator, BlockSpiller spiller, ReadRecordsRequest recordsRequest, QueryStatusChecker queryStatusChecker) throws Exception
    {
        ...
        try (Consumer<String, TopicResultSet> kafkaConsumer = KafkaUtils.getKafkaConsumer(ProtobufMessageConverter.fromProtoSchema(allocator, recordsRequest.getSchema()), configOptions)) {
