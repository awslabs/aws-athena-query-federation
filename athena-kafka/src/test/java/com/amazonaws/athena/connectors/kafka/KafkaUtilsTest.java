...
public class KafkaUtilsTest {
    ...
    public void testGetScramAuthKafkaProperties() throws Exception {
        environmentVariables.set("auth_type", KafkaUtils.AuthType.SASL_SSL_SCRAM_SHA512.toString());
    ...
    public void testGetKafkaConsumerWithSchema() throws Exception {
        environmentVariables.set("auth_type", KafkaUtils.AuthType.NO_AUTH.toString());
        ...
        Consumer<String, TopicResultSet> consumer = KafkaUtils.getKafkaConsumer(schema);
