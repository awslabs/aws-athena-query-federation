...
public class ListTablesRequestSerDeTest
{
    ...
    private ListTablesRequestSerDe serde = new ListTablesRequestSerDe(new FederatedIdentitySerDe());

    private BlockAllocator allocator;

    private ListTablesRequest expected;
            ...
            throws IOException
    {
        ...
        String expectedSerDeFile = utils.getResourceOrFail("serde/v24", "ListTablesRequest.json");
            ...
            throws IOException
    {
        ...
        ListTablesRequest actual = (ListTablesRequest) serde.deserialize(jparser);
            ...
            throws IOException
    {
        ...
        ListTablesRequest actual = (ListTablesRequest) federationRequestSerDe.deserialize(jparser);
