...
public class ExampleRecordHandlerTest
{
    ...
    public void setUp()
    {
        ...
        recordService = new LocalHandler(allocator, amazonS3, awsSecretsManager);
            ...
            implements RecordService
    {
        ...
        public LocalHandler(BlockAllocatorImpl allocator, AmazonS3 amazonS3, AWSSecretsManager secretsManager)
        {
            handler = new ExampleRecordHandler(amazonS3, secretsManager);
