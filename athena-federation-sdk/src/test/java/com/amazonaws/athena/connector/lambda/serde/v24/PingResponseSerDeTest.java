...
public class PingResponseSerDeTest
{
            ...
            throws IOException
    {
        ...
        serde = v24SerDeProvider.getPingResponseSerDe();

        expected = new PingResponse("test-catalog", "test-query-id", "test-source-type", 24);

        String expectedSerDeFile = utils.getResourceOrFail("serde/v24", "PingResponse.json");
            ...
            throws IOException
    {
        ...
        PingResponse actual = (PingResponse) serde.deserialize(jparser);
            ...
            throws IOException
    {
        ...
        PingResponse actual = (PingResponse) federationResponseSerDe.deserialize(jparser);
