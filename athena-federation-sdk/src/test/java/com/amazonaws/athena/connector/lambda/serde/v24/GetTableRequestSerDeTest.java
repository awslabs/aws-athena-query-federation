...
public class GetTableRequestSerDeTest extends SerDeTest<FederationRequest>
{
            ...
            throws IOException
    {
        ...
        serde = serDeProvider.getGetTableRequestSerDe();
        ...
        String expectedSerDeFile = utils.getResourceOrFail("serde/v24", "GetTableRequest.json");
            ...
            throws IOException
    {
        ...
        GetTableRequest actual = (GetTableRequest) serde.deserialize(jparser);
            ...
            throws IOException
    {
        ...
        GetTableRequest actual = (GetTableRequest) federationRequestSerDe.deserialize(jparser);
