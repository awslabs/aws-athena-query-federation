...
public class GetSplitsResponseSerDeTest extends SerDeTest<FederationResponse>
{
            ...
            throws IOException
    {
        ...
        String expectedSerDeFile = utils.getResourceOrFail("serde/v24", "GetSplitsResponse.json");
            ...
            throws IOException
    {
        ...
        GetSplitsResponse actual = (GetSplitsResponse) serde.deserialize(jparser);
            ...
            throws IOException
    {
        ...
        GetSplitsResponse actual = (GetSplitsResponse) federationResponseSerDe.deserialize(jparser);
