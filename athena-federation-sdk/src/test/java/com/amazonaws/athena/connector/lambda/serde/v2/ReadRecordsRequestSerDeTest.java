...
public class ReadRecordsRequestSerDeTest extends TypedSerDeTest<FederationRequest>
{
            ...
            throws IOException
    {
        ...
        ReadRecordsRequest actual = (ReadRecordsRequest) mapper.readValue(input, FederationRequest.class);
