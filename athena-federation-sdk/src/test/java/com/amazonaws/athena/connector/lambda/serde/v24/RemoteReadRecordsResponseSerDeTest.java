...
public class RemoteReadRecordsResponseSerDeTest
{
            ...
            throws IOException
    {
        ...
        expected = new RemoteReadRecordsResponse(
                "test-catalog",
                schema,
                ImmutableList.of(spillLocation1, spillLocation2),
                encryptionKey);

        String expectedSerDeFile = utils.getResourceOrFail("serde/v24", "RemoteReadRecordsResponse.json");
            ...
            throws IOException
    {
        ...
        RemoteReadRecordsResponse actual = (RemoteReadRecordsResponse) serde.deserialize(jparser);
            ...
            throws IOException
    {
        ...
        RemoteReadRecordsResponse actual = (RemoteReadRecordsResponse) federationResponseSerDe.deserialize(jparser);
