...
public class ListSchemasResponseSerDeTest extends SerDeTest<FederationResponse>
{
            ...
            throws IOException
    {
        ...
        String expectedSerDeFile = utils.getResourceOrFail("serde/v24", "ListSchemasResponse.json");
            ...
            throws IOException
    {
        ...
        ListSchemasResponse actual = (ListSchemasResponse) serde.deserialize(jparser);
            ...
            throws IOException
    {
        ...
        ListSchemasResponse actual = (ListSchemasResponse) federationResponseSerDe.deserialize(jparser);
