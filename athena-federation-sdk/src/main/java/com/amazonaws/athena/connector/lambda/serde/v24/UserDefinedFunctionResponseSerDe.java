...
public class UserDefinedFunctionResponseSerDe extends TypedSerDe<FederationResponse>
{
            ...
            throws IOException
    {
        ...
        blockSerDe.serialize(jgen, userDefinedFunctionResponse.getRecords());

        jgen.writeStringField(METHOD_NAME_FIELD, userDefinedFunctionResponse.getMethodName());
    }

    @Override
    public UserDefinedFunctionResponse doDeserialize(JsonParser jparser)
            throws IOException
    {
