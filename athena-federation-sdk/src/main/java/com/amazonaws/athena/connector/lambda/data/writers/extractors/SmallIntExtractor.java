...
/**
 * Used to extract a SmallInt value from the context object. This interface enables the use of a pseudo-code generator
        ...
        extends Extractor
{
     ...
     */
    void extract(Object context, NullableSmallIntHolder dst) throws Exception;
}
