...
public class TableNameSerDe extends BaseSerDe<TableName>
{
    private static final String SCHEMA_NAME_FIELD = "schemaName";
    private static final String TABLE_NAME_FIELD = "tableName";

    @Override
    public void doSerialize(JsonGenerator jgen, TableName tableName)
            throws IOException
    {
    ...
    @Override
    public TableName doDeserialize(JsonParser jparser)
            throws IOException
    {
