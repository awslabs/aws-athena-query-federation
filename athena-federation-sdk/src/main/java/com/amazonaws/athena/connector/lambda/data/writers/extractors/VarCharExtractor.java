...
/**
 * Used to extract a VarChar value from the context object. This interface enables the use of a pseudo-code generator
        ...
        extends Extractor
{
     ...
     */
    void extract(Object context, NullableVarCharHolder dst) throws Exception;
}
