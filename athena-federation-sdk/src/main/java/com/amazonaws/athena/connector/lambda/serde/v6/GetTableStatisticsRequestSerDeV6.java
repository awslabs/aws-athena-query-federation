...
public class GetTableStatisticsRequestSerDeV6
{
    private static final String TABLE_NAME_FIELD = "tableName";

    private GetTableStatisticsRequestSerDeV6() {}
    ...
    public static final class Serializer extends MetadataRequestSerializer
    {
        ...
        {
            super(GetTableStatisticsRequest.class, identitySerializer);
        ...
        protected void doRequestSerialize(FederationRequest federationRequest, JsonGenerator jgen, SerializerProvider provider)
                throws IOException
        {
            GetTableStatisticsRequest request = (GetTableStatisticsRequest) federationRequest;

            jgen.writeFieldName(TABLE_NAME_FIELD);
            tableNameSerializer.serialize(request.getTableName(), jgen, provider);
        }
    }
    ...
    public static final class Deserializer extends MetadataRequestDeserializer
    {
        ...
        {
            super(GetTableStatisticsRequest.class, identityDeserializer);
                ...
                throws IOException
        {
            ...
            return new GetTableStatisticsRequest(identity, queryId, catalogName, tableName);
        }
    }
}
