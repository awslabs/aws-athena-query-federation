...
/**
 * Used to extract a TinyInt value from the context object. This interface enables the use of a pseudo-code generator
        ...
        extends Extractor
{
     ...
     */
    void extract(Object context, NullableTinyIntHolder dst) throws Exception;
}
