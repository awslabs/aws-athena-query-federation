         ...
         implements FieldWriter
 {
     ...
     public SmallIntFieldWriter(SmallIntExtractor extractor, SmallIntVector vector, ConstraintProjector rawConstraint)
     {
         ...
         if (rawConstraint != null) {
             constraint = (NullableSmallIntHolder value) -> rawConstraint.apply(value.isSet == 0 ? null : value.value);
         }
         else {
             constraint = (NullableSmallIntHolder value) -> true;
         }
     }
     ...
     {
         boolean apply(NullableSmallIntHolder value);
     }
 }
