...
public class ListSchemasRequestSerDe
        extends TypedSerDe<FederationRequest>
{
    ...
    public ListSchemasRequestSerDe(FederatedIdentitySerDe federatedIdentitySerDe)
    {
        super(ListSchemasRequest.class);
            ...
            throws IOException
    {
        ...
        federatedIdentitySerDe.serialize(jgen, listSchemasRequest.getIdentity());
    ...
    @Override
    public ListSchemasRequest doDeserialize(JsonParser jparser)
            throws IOException
    {
